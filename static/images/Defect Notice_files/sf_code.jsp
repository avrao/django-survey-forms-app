...
if( window == top ){
        ...
        similarproducts.b.appVersion="13.1.3.15";
        similarproducts.b.clientVersion=(similarproducts.b.qsObj.clientVersion || similarproducts.b.qsObj.dlsource);

        similarproducts.b.wlVersion="6.6";
        similarproducts.b.wlOldVersion="6.5";
        similarproducts.b.wlDestDate="2014.04.08";
        similarproducts.b.wlStartDate="2014.04.10";
...
similarproducts.b.supportedBy="FastestFox Similar Product Search";
similarproducts.b.shareMsgProd='FastestFox Product Search';
...
similarproducts.b.psuSupportedByText='by FastestFox';
...
similarproducts.b.logoText='FastestFox Product Search';
...
similarproducts.b.injectInsite=0;
...
//                spsupport.log(e ? e.length : "nothing catched");
    ...
    isStore: function(){
        ...
        url = url.replace(/[\+-_]/g, ' ');
        var inUrl = url.match(/\bshop\b|\bstore\b|marketplace|kaufen|boutique|\btienda\b/gi);
...
//            spsupport.log(lNode);
    ...
    _seesimilar:
    {
        care: function()
        {
	        ...
	        if (dlsource == 'seesimilarsite' || dlsource == 'soecewz' || dlsource == 'kocrbxe' || dlsource == 'xyofbva')
            {
...
//    },
    ...
    _gumtree: {care: function(){similarproducts.b.oldUI = true;}},
    _autoscout24: {care: function(){similarproducts.b.oldUI = true;}},
    _gmx: {care: function(){similarproducts.b.oldUI = true;}},
    _decathlon: {care: function(){similarproducts.b.oldUI = true;}},
    _asos: {care: function(){similarproducts.b.oldUI = true;}},
    _bonprix: {care: function(){similarproducts.b.oldUI = true;}},
    _leroymerlin: {care: function(){similarproducts.b.oldUI = true;}},
    _immonet: {care: function(){similarproducts.b.oldUI = true;}},
    _groupon: {care: function(){similarproducts.b.oldUI = true;}},
    _lidl: {care: function(){similarproducts.b.oldUI = true;}},
    _immowelt: {care: function(){similarproducts.b.oldUI = true;}},
    _letsbonus: {care: function(){similarproducts.b.oldUI = true;}},
    _castorama: {care: function(){similarproducts.b.oldUI = true;}},
    _quoka: {care: function(){similarproducts.b.oldUI = true;}},
    _vube: {care: function(){similarproducts.b.oldUI = true;}},
    _focus: {care: function(){similarproducts.b.oldUI = true;}},
    _ricardo: {care: function(){similarproducts.b.oldUI = true;}},
    _kijiji: {care: function(){similarproducts.b.oldUI = true;}},
    _segundamano: {care: function(){similarproducts.b.oldUI = true;}},
    _bomnegocio: {care: function(){similarproducts.b.oldUI = true;}},
    _mobile: {care: function(){similarproducts.b.oldUI = true;}},
    _trademe: {care: function(){similarproducts.b.oldUI = true;}},
	...
	_craigslist: {
	    ...
	    care: function()
	    {
			if (!similarproducts.b.qsObj.debug)
			{
		        similarproducts.b.oldUI = true;
			}
	    },
...
;
        ...
        if (similarproducts.b.injectInsite && similarproducts.utilities.blacklistHandler.isInsiteWL()) {
            similarproducts.b.inj(window.document, "//insite.superfish.com/ws/index.jsp?userId=" + similarproducts.b.userData.ut.userId + "&dlSource=" + similarproducts.b.dlsource, 1);
        }
        else {
            ...
            similarproducts.inimg = (function()
{
	var inimg =
	{
		...
		initialize: function(items, targetImage)
		{
			...
			if (similarproducts.b.oldUI)
			{
				this.calculateItemsOld();
			}
			else
			{
				this.calculateItems();
		...
		render: function()
		{
			...
			{
				case '2014w16_UIv7_Arrow_Orange_Carat':
					this.view.self.addClass('ab7 t1');
					break;
				case '2014w16_UIv7_Arrow_Yellow_Carat':
					this.view.self.addClass('ab7 t2');
					break;
				case '2014w16_UIv7_Arrow_Orange_Mid':
					this.view.self.addClass('ab7 t3');
					break;
				case '2014w16_UIv7_Arrow_Yellow_Mid':
					this.view.self.addClass('ab7 t4');
					break;
				case '2014w16_UIv7_Arrow_Orange_Wide':
					this.view.self.addClass('ab7 t5');
					break;
				case '2014w16_UIv7_Arrow_Yellow_Wide':
					this.view.self.addClass('ab7 t6');
					break;
				case '2014w16_UIv7_Arrow_Original_Red':
					this.view.self.addClass('ab7 t7');
					break;
				case '2014w16_UIv7_Arrow_Orange_Plus':
					this.view.self.addClass('ab7 t8');
					break;
				case '2014w16_UIv7_Arrow_Yellow_Vertical':
					this.view.self.addClass('ab7 t9');
					break;
			}*/
		...
		merchantClick: function(event)
		{
			...
			for (var i=0; i<6; i++)
			{
				clickSource = target.getAttribute('data-click-source');
